...
const WavyTop = ({ fill }: { fill: string }) => (
	<div className="absolute top-0 left-0 right-0 -translate-y-[1px]">
		<svg viewBox="0 0 1440 60" className="w-full h-auto">
			<path
				d="M0,0 L1440,0 L1440,20 C1080,60 720,0 360,40 C180,55 0,30 0,20 Z"
				fill={fill}
			/>
		</svg>
	</div>
				...
				<section className="relative overflow-hidden py-24">
					...
					<div className="container mx-auto px-4 text-center relative z-10">
						...
						<p className="text-primary-foreground/80 max-w-2xl mx-auto text-lg mb-6">
							Alle Preise beinhalten Sicherheitsausrüstung,
							professionelle Einweisung und 3 Stunden Kletterzeit.
						</p>
						<Button
							asChild
							size="lg"
				...
				<section className="relative overflow-hidden py-16">
					<div className="container mx-auto px-4">
						...
						<p className="text-sm text-muted-foreground text-center mt-6 max-w-2xl mx-auto">
							* Schüler, Azubis und Studenten klettern zum
							Jugendtarif (25 €) – unabhängig vom Alter. Bitte
					...
					<div className="container mx-auto px-4">
						<div className="text-center mb-12">
							...
							<p className="text-muted-foreground text-lg">
								Noch mehr Abenteuer für Vielkletterer und
								Familien
							</p>
						</div>
						<div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
							{extras.map((e) => (
								...
								>
									<Card
										className={`relative text-center hover:shadow-lg hover:border-primary transition-all h-full ${
											e.highlight
												? "border-2 border-accent shadow-lg scale-[1.03]"
												: ""
										}`}
					...
					<div className="container mx-auto px-4 max-w-3xl">
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
							{[
								{
									icon: ShieldCheck,
									text: "Komplette Sicherheitsausrüstung",
								},
								{
									icon: Clock,
									text: "Ca. 20 Min. Sicherheitseinweisung",
								},
								{ icon: Clock, text: "3 Stunden Kletterzeit" },
								{
									icon: HelpCircle,
									text: "Betreuung durch geschultes Personal",
								},
							].map((item) => (
								<div
									key={item.text}
				...
				<section className="py-16">
					<div className="container mx-auto px-4 text-center">
						...
						<p className="text-muted-foreground mb-8 max-w-lg mx-auto">
							Sichere dir jetzt deinen Platz im Kletterwald
							Staufen – Vorab-Reservierung empfohlen!
						</p>
						<Button
							asChild
							size="lg"
