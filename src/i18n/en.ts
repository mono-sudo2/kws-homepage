...
export const en: Translations = {
		...
		items: [
			{
				...
				specialCourse: {
					name: "MiDi",
					color: "yellow-blue",
					note: "Only for fit children – with adult supervision",
				},
			},
			{
				name: "Zip Lines",
				...
				description:
					"Fast zip lines through the forest – for those seeking thrills!",
				badge: "",
				courses: [
					{ name: "S1", color: "green" },
					{ name: "S2", color: "green" },
			...
			},
			{
				...
				minHeight: "from 130 cm",
				description:
					"Challenging stations for experienced climbers. This is where it gets really demanding!",
				badge: "",
				courses: [
					{ name: "B1", color: "red" },
					{ name: "B2", color: "red" },
		...
		attractions: [
			{
				...
				minHeight: "from 130 cm",
				description:
					"Jump from dizzying heights – the ultimate adrenaline rush!",
			},
			{
				name: "Jump & Fly",
				minHeight: "from 130 cm",
	...
	preise: {
		...
		footnote:
			"* Only with adult supervision. One adult can supervise a maximum of two children.",
	...
	reservierung: {
		...
		description:
			"Opening hours vary by season and weather. Check the calendar to see when we're open!",
		seasons: {
			hauptsaison: {
	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "No, you don't need any prior experience! Before starting, you'll receive an approx. 30-minute safety briefing from our trained team. After that, you're perfectly prepared for your climbing adventure.",
			},
			{
			...
			},
			{
				...
				answer: "Your entry ticket is valid for 3 hours – including approx. 30 min. safety briefing. Afterwards, you're very welcome to stay in the forest area, have a picnic and enjoy nature.",
			},
			{
		...
		faqs: [
			{
				...
				answer: "The admission price includes: safety equipment (climbing harness, helmet, gloves), safety briefing (approx. 30 min.) and access to the approved courses.",
			},
			{
				question: "Are there discounts?",
				answer: "Yes! Group discount from 20 persons (€2 discount p.p.), season passes for frequent climbers and special family cards. Holders of the Black Forest Card receive 10% discount.",
			},
			{
		...
		categories: [
			{
				...
				note: "Children's course",
				details:
					"Access to children's course. Children under 12 only accompanied by an adult.",
			},
			{
				category: "M",
				height: "from 130 cm",
				...
				note: "All courses incl.*",
				details:
					"Access to all courses. Children under 12 only accompanied by an adult.",
			},
			{
				category: "L",
				height: "from 130 cm",
				...
				note: "All courses incl.",
				details:
					"Unrestricted access to all courses incl. Base Jump & zip lines.",
			},
		],
	},
	oeffnungszeitenPage: {
	...
	jobsPage: {
		...
		aboutText1:
			"Since 2010, Kletterwald Staufen has been an integral part of the region – as one of the largest climbing forests in southern Baden, we welcome thousands of visitors annually to our treetops. With over 200 climbing elements, we offer adventure for every age.",
		aboutText2:
	...
	abenteuerPage: {
		...
		description:
			"Courses, attractions and treasure hunt – experience unforgettable moments in the treetops.",
		treasureHunt: {
			badge: "Treasure Hunt",
			title: "Treasure Hunt in the Climbing Forest",
			description:
				"A special experience for birthday parties and groups – find the hidden treasure!",
			cardTitle: "Treasure Hunt",
			cardDescription:
				"Perfect for birthdays and special occasions. The children solve riddles and tasks in the forest to find the treasure. An unforgettable adventure!",
			price: "€65",
