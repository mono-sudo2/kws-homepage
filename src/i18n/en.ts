...
export const en: Translations = {
  ...
  parcours: {
    ...
    items: [
      { name: "Children's Course", duration: "approx. 45 min.", minHeight: "from 120 cm", description: "The perfect start for little adventurers! Low height, lots of fun and child-friendly stations." },
      { name: "Beginners & Families", duration: "approx. 1.5 hrs.", minHeight: "from 140 cm", description: "Ideal for families and climbing beginners. Varied elements at moderate height." },
      { name: "Zip Lines & Free Jumps", duration: "approx. 2 hrs.", minHeight: "from 150 cm", description: "Fast zip lines and exciting free jumps – for those seeking thrills!" },
      { name: "Base Jump / Jump & Fly", duration: "approx. 2.5 hrs.", minHeight: "from 160 cm", description: "The ultimate adrenaline rush! Jump from dizzying heights and fly through the treetops." },
    ],
  },
  preise: {
    badge: "Prices",
    ...
    categories: [
      { category: "Children", age: "6–13 years", price: "€19", note: "Children's course incl." },
      { category: "Teenagers", age: "14–17 years", price: "€25", note: "All courses incl." },
      { category: "Adults", age: "18+ years", price: "€30", note: "All courses incl." },
    ],
  ...
  reservierung: {
    ...
    description: "Opening hours vary by season. Check the calendar to see when we're open!",
    seasons: {
  ...
  events: {
    ...
    items: [
      ...
      { title: "School Classes", description: "A trip nobody forgets! Special school rates and pedagogically guided programs for all ages.", features: ["Special rates (€23 p.p.)", "From 20 persons", "Pedagogical guidance", "Bus line 23 direct"] },
    ],
  },
  faq: {
    badge: "FAQ",
    ...
    items: [
      { question: "What is the minimum age for climbing?", answer: "Children from 6 years and a minimum height of 120 cm may climb on our children's course. From 140 cm height, all courses are accessible. Children under 14 must be accompanied by an adult." },
      { question: "Do I need prior experience?", answer: "No, you don't need any prior experience! Before starting, you'll receive an approx. 20-minute safety briefing from our trained team. After that, you're perfectly prepared for your climbing adventure." },
      ...
      { question: "How long does a visit take?", answer: "Plan for approx. 2.5 to 3.5 hours – including the safety briefing (approx. 20 min.). There is no time limit on the courses, you can climb as long as you like!" },
  ...
  preisePage: {
    ...
    faqs: [
      { question: "What is included in the price?", answer: "The admission price includes: safety equipment (climbing harness, helmet, gloves), professional safety briefing (approx. 20 min.) and unlimited access to the approved courses for the entire day." },
      { question: "Are there discounts?", answer: "Yes! Group discount from 10 persons (€2 discount p.p.), season passes for frequent climbers and special family cards. Holders of the Black Forest Card receive 10% discount." },
      ...
      { question: "Are there age or height restrictions?", answer: "Children from 6 years and at least 120 cm height may use the children's course. From 140 cm, all courses are accessible. Children under 14 must be accompanied by an adult." },
    ],
    ...
    categories: [
      { category: "Children", age: "6–13 years", price: "€19", note: "Children's course incl.", details: "Access to children's course & beginner course. Children under 14 only accompanied by an adult." },
      { category: "Teenagers", age: "14–17 years", price: "€25", note: "All courses incl.", details: "Access to all courses. Teenagers from 14 may climb without accompaniment (with parental consent form)." },
      { category: "Adults*", age: "18+ years", price: "€30", note: "All courses incl.", details: "Unrestricted access to all courses incl. Base Jump & zip lines. No time limit." },
    ],
  },
  oeffnungszeitenPage: {
    badge: "Opening Hours",
  ...
  jobsPage: {
    ...
    aboutText1: "Since 2010, Kletterwald Staufen has been an integral part of the region – as the largest climbing park in southern Baden, we welcome over 100,000 visitors annually to our treetops. With over 200 climbing elements, we offer adventure for every age.",
