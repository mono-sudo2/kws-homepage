...
export const fr: Translations = {
	...
	parcours: {
		...
		attractionsDescription:
			"Encore plus d'action pour les amateurs d'adrénaline !",
		...
		items: [
			{
				...
				specialCourse: {
					name: "MiDi",
					color: "yellow-blue",
					note: "Uniquement pour les enfants en forme – accompagnés d'un adulte",
				},
			},
			{
				name: "Tyroliennes",
				...
				description:
					"Tyroliennes rapides à travers la forêt – pour ceux qui recherchent le frisson !",
				badge: "",
				courses: [
					{ name: "S1", color: "green" },
					{ name: "S2", color: "green" },
			...
			},
			{
				...
				minHeight: "à partir de 130 cm",
				description:
					"Idéal pour les familles et les débutants. Des éléments variés à hauteur modérée.",
				badge: "",
				courses: [
			...
			},
			{
				...
				minHeight: "à partir de 130 cm",
				description:
					"Stations exigeantes pour grimpeurs expérimentés. Ici, ça devient vraiment corsé !",
				badge: "",
				courses: [
					{ name: "B1", color: "red" },
					{ name: "B2", color: "red" },
		...
		attractions: [
			{
				...
				minHeight: "à partir de 130 cm",
				description:
					"Sautez de hauteurs vertigineuses – la montée d'adrénaline ultime !",
			},
			{
				name: "Jump & Fly",
				minHeight: "à partir de 130 cm",
				description:
					"Volez à travers les cimes – assuré par une corde pour un maximum de plaisir !",
			},
		],
	},
	preise: {
		...
		footnote:
			"* Uniquement accompagné d'un adulte. Un adulte peut encadrer deux enfants maximum.",
	...
	reservierung: {
		...
		description:
			"Les horaires varient selon la saison et la météo. Consultez le calendrier pour savoir quand nous sommes ouverts !",
		seasons: {
			hauptsaison: {
	...
	faq: {
		...
		items: [
			...
			},
			{
				...
				answer: "Non, aucune expérience n'est nécessaire ! Avant de commencer, vous recevrez un briefing sécurité d'env. 30 minutes par notre équipe formée. Ensuite, vous serez parfaitement préparé pour votre aventure d'escalade.",
			},
			{
			...
			},
			{
				...
				answer: "Votre billet d'entrée est valable 3 heures – y compris env. 30 min. de briefing sécurité. Ensuite, vous êtes les bienvenus pour rester dans l'espace forestier, pique-niquer et profiter de la nature.",
			},
			{
		...
		faqs: [
			{
				...
				answer: "Le prix d'entrée comprend : équipement de sécurité (harnais, casque, gants), briefing sécurité (env. 30 min.) et accès aux parcours autorisés.",
			},
			{
				question: "Y a-t-il des réductions ?",
				answer: "Oui ! Réduction groupe à partir de 20 personnes (2 € de réduction p.p.), pass saison pour les grimpeurs réguliers et cartes famille spéciales. Les détenteurs de la Schwarzwald-Card bénéficient de 10% de réduction.",
			},
			{
		...
		categories: [
			{
				...
				note: "Parcours enfants",
				details:
					"Accès au parcours enfants. Enfants de moins de 12 ans uniquement accompagnés d'un adulte.",
			},
			{
				category: "M",
				height: "dès 130 cm",
				...
				note: "Tous parcours inclus*",
				details:
					"Accès à tous les parcours. Enfants de moins de 12 ans uniquement accompagnés d'un adulte.",
			},
			{
				category: "L",
				...
				note: "Tous parcours inclus",
				details:
					"Accès illimité à tous les parcours incl. Base Jump & tyroliennes.",
			},
		],
	},
	oeffnungszeitenPage: {
	...
	jobsPage: {
		...
		aboutText1:
			"Depuis 2010, le Kletterwald Staufen fait partie intégrante de la région – en tant que l'un des plus grands parcs d'accrobranche du sud du Bade, nous accueillons des milliers de visiteurs par an dans nos cimes. Avec plus de 200 éléments d'escalade, nous offrons de l'aventure pour tous les âges.",
		aboutText2:
	...
	abenteuerPage: {
		...
		description:
			"Parcours, attractions et chasse au trésor – vivez des moments inoubliables dans les cimes.",
		treasureHunt: {
			badge: "Chasse au trésor",
			title: "Chasse au trésor dans le parc d'escalade",
			description:
				"Une expérience spéciale pour les anniversaires et les groupes – trouvez le trésor caché !",
			cardTitle: "Chasse au trésor",
			cardDescription:
				"Parfait pour les anniversaires et les occasions spéciales. Les enfants résolvent des énigmes et des défis dans la forêt pour trouver le trésor. Une aventure inoubliable !",
			price: "65 €",
